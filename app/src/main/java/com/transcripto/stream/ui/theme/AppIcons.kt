...
/**
 * Icônes vectorielles de l'app (tracés Material Symbols, grille 24 dp).
 * Seule la bibliothèque « material-icons-core » est embarquée : les icônes
 * métier absentes de ce noyau (micro, forme d'onde, cadenas de sauvegarde…)
 * sont définies ici, tintées comme n'importe quelle ImageVector.
 */
object AppIcons {
    ...
    /** Deux silhouettes : intervenants, empreintes vocales. */
    ...
    /** Forme d'onde : audio, transcription locale. */
    val Waveform: ImageVector by lazy {
        icon("Waveform", "M7 18h2V6H7v12zm4 4h2V2h-2v20zm-8-8h2v-4H3v4zm12 4h2V6h-2v12zm4-8v4h2v-4h-2z")
    }

    /** Document texte : entrée « texte seul », transcription. */
    ...
    /** Bouclier coché : traitement 100 % local, sécurité. */
    ...
    val Upload: ImageVector by lazy { icon("Upload", "M9 16h6v-6h4l-7-7-7 7h4zm-4 2h14v2H5z") }
    ...
    /** Étincelles : synthèse (locale ou IA). */
    ...
    val Dictation: ImageVector by lazy {
        icon(
            "Dictation",
